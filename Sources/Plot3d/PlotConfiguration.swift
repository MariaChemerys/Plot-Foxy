...
public struct PlotConfiguration {
    ...
    public init(xAxisHeight: CGFloat = 7,
                ...
                axisRadius: CGFloat = 0.015,
                gridlineRadius: CGFloat = 0.009,
                arrowBottomRadius: CGFloat = 0.08,
                arrowHeight: CGFloat = 0.15,
                ...
                yMin: CGFloat = 0,
                zMin: CGFloat = 0,
                xyGridColor: UIColor = UIColor.white.withAlphaComponent(0.5),
                xzGridColor: UIColor = UIColor.white.withAlphaComponent(0.5),
                yzGridColor: UIColor = UIColor.white.withAlphaComponent(0.5),
                xyUnitPlaneColor: UIColor = UIColor.white,
                xzUnitPlaneColor: UIColor = UIColor.white,
                yzUnitPlaneColor: UIColor = UIColor.white,
                xyPlaneColor: UIColor = UIColor.lightGray.withAlphaComponent(0.3),
                xzPlaneColor: UIColor = UIColor.lightGray.withAlphaComponent(0.3),
                yzPlaneColor: UIColor = UIColor.lightGray.withAlphaComponent(0.3),
